...
class NeatoFetch(Node):
    ...
    def loop_wrapper(self):
        ...
        #     255,
        #     self.set_green_lower_bound,
        # )
        # cv2.createTrackbar(
        #     "blue lower bound",
        #     "binary_window",
        #     self.blue_lower_bound,
        #     255,
        #     self.set_blue_lower_bound,
        # )
        # cv2.createTrackbar(
        #     "red upper bound",
        #     "binary_window",
    ...
    def process_mouse_event(self, event, x, y, flags, param):
        ...
        cv2.putText(
            self.image_info_window,
            "Color (b=%d,g=%d,r=%d)"
            % (self.cv_image[y, x, 0], self.cv_image[y, x, 1], self.cv_image[y, x, 2]),
            (5, 50),
